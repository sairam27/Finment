...
if (isset($_POST['fid'])) {
	   ...
	   $fid = $_POST['fid'];
		$sql = "SELECT email,amountinvest,amountback,interestrate,category
            FROM investorrequest WHERE access_id='$fid' AND (category='invest' OR category='backamt') AND(iapproval='0' OR baapproval='0') ORDER BY created_at DESC ";
