		...
		$message='
			...
			<div  style=" border:1px solid grey; padding:20px;">
			        ...
			        <div style="width:100%;background-color:#C0392B;line-height:40px;margin:0px auto;border-radius: .25rem;" >
			        	<a href="http://192.168.225.32:80/Finment/confirm.php?fname='.$fname.'&passkey='.$confirmation.'&email='.$email.'" style="color:white;text-align:center;text-decoration:none;display:block;"> Activate My Account </a>
					</div>       
			 		<br><br><br>
	        		<div>
