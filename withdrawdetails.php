...
if (isset($_POST['fid']) && isset($_POST['email']) && isset($_POST['category']) ) {
		...
		$sql = "SELECT created_at,amountback,totamtback,baapproval FROM investorrequest WHERE access_id='$fid' and email='$email' and category='$category' ORDER by created_at DESC";
